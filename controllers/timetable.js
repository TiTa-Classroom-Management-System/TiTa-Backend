...
const createTimetable = async (req, res) =>
{
    ...
    var sub_class_id = 0;
    db.query("SELECT sub_class_id FROM sub_class WHERE class_id = ? AND grp_no = ?",
                    ...
                    (err, results, fields) =>
                    {
                        ...
                        db.query("SELECT * FROM timetable WHERE sub_class_id = ? AND start_time = ? AND day = ?", 
                                    ...
                                    (err, results, fields) =>
                                    {
                                        ...
                                        if(results.length === 0)
                                        {
                                            db.query("INSERT into timetable (sub_class_id, start_time, end_time, day, type) VALUES (?, ?, ?, ?, ?)",
